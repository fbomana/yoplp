...
public class TimerService extends IntentService
{
    ...
    {
        Log.i("[TimeService]", "onStartCommand stop=[" + stop.get() + "] intent=[" + intent.getAction() + "]");
    ...
    protected void onHandleIntent(Intent intent)
    {
        ...
        while( !stop.get())
        {
            ...
            {
                Log.i("[TimeService]", "Excepcion en onHandleItemSleep", e);
                break;
            }
            mp = MediaPlayerAdapter.getInstance().getActualPlayer();
        }
        Log.i("[TimeService]", "Fin del bucle");
        stopSelf();
    }
}
